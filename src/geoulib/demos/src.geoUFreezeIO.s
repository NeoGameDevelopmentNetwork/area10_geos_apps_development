...
;--- Hinweis:
;Für CMD_FREEZE ist unter GEOS128 die
;Routine :InitForIO erforderlich.
;Wird nur :ULIB_IO_ENABLE verwendet,
;dann zeigt der 40Z-Bildschirm Fehler
;im Bildaufbau.

			jsr	InitForIO		;IRQ sperren, I/O ein.

			jsr	ULIB_SEND_ABORT		;Abbruch senden.

			jsr	_UCIC_FREEZE		;Menü aufrufen.

			jsr	DoneWithIO		;I/O aus, IRQ freigeben.
