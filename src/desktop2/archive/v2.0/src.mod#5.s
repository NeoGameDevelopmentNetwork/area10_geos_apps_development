...
;--- Hinweis:
;Code der US-Version von DeskTop. Hier
;wurde wieder mit Makros gearbeitet.
;Da bei "LOADB adr,val" der Inhalt von
;AKKU zerstört wird, sichert man diesen
;vorher auf dem Stack. Makro-Madness!
;			pha
;			lda	#"1"
;			sta	stringCurTime +1
;			pla
...
;--- Hinweis:
;Der folgende JMP-Befehl ist unnötig,
;da die Routine ":invertCursor" direkt
;im Anschluss folgt!
			jmp	invertCursor
...
;*** Dezimal-Zahl nach ASCII/BCD wandeln.
;Wird nicht verwendet!
:__convDez2BCD		jsr	convDez2ASCII
...
:dbtx_Compat4		b "booten (aber mit GEOS V2.0)."
			b NULL
;--- Hinweis:
;Zeile 5 wird nicht verwendet. Evtl.
;ein Überrest aus der Übersetzung?
:dbtx_Compat5		b NULL
endif
if LANG = LANG_EN
