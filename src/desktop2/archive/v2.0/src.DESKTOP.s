...
if LANG = LANG_DE
:classDeskTop		b "deskTop  GE V2.0",NULL
endif
if LANG = LANG_EN
:classDeskTop		b "deskTop AM  V2.0",NULL
endif
...
:moveBorderToPad	jsr	sysDkDelSysFiles
...
:copyBorderToPad	jsr	sysDkDelSysFiles

			lda	numDrives
			cmp	#$01			;Mehr als 1 Lwfk.?
			bne	:1			; => Ja, weiter...
...
;--- Fehler!
;Hier findet keine Prüfung statt ob der
;linke Textrand unterschritten wird!
;Wird der Name eines Druckertreibers
;mit sehr breitem Namen ausgegeben,
;dann ist die X-Koordinate eventuell
;kleiner 0! In dem Fall wird dann kein
...
;*** Nur in der DE-Version?
if LANG = LANG_DE
			b $4c
endif

;*** Ungenutzter Speicher.
;MAIN_EOF		= $5b25 bei DeskTop/DE.

;*** Startadresse für VLIR-Module.
if LANG = LANG_DE
.vlirModBase		= $5b46				;DeskTop/DE.
endif
if LANG = LANG_EN
.vlirModBase		= $5b1e				;DeskTop/EN.
endif
