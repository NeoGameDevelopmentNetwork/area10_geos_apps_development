...
;--- Hinweis:
;Fehlende Abfrage für "Puffer voll"
;ergänzt: Damit wird ein Problem mit
;ScreenGarbage beim Abbau einer Dialog-
;box über einen Hintergrundmuster #2
;behoben. Dieses Muster lässt sich
;nicht effektiv packen. Dann kann der
;Puffer voll sein und anschließend
;werden falsche Daten entpackt.
			ldx	#$00
			lda	r1H			;Puffer voll?
			cmp	#> dirDiskBuf
			bcs	:write			; => Ja, weiter...
