...
:PrintSpoolMenu		jsr	RegisterSetFont		;8-Punkte-Font aktivieren.
			...
			jsr	i_ColorBox		;Icon-Menü aktivieren.
			b	$00,$01,$0f,$03,$0d
...
:RegMenu01		b 14
			...
			b BOX_NUMERIC			;----------------------------------------
				...
				w $0040
;--- Ergänzung: 08.07.18/M.Kanet
;Code-Rekonstruktion: In der MP3/2003-Version wird die Nummer des
...
if Sprache = Deutsch
:RegMenuText01_a	w $0020
			b $46
			b "Nr.",NULL
:RegMenuText01_b	w $00b8
			b $a6
			b "Dokument drucken",NULL
:RegMenuText01_c	w $0038
			b $66
			b "Alle Seiten drucken",NULL
:RegMenuText01_d	w $0038
			b $76
			b "Nur bestimmte Seiten drucken",NULL
:RegMenuText01_e	w $0050
			b $86
			b "Erste Seite",NULL
:RegMenuText01_f	w $0050
			b $96
			b "Letzte Seite",NULL
:RegMenuText01_g	w $00b8
			b $86
			b "Ungerade Seiten",NULL
:RegMenuText01_h	w $00b8
			b $96
			b "Gerade Seiten",NULL
:RegMenuText01_i	w $0040
			b $a6
			b "Anzahl Kopien",NULL
:RegMenuText01_j	w $00f4
			b $46
			b "Gedruckt",NULL
...
:RegTText1_2_02		w $0020
			b $4e
			b "Name:"
			b NULL

:RegTText1_2_03		w $0020
			b $5e
