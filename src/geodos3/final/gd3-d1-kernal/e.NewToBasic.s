...
;BASIC-Linkzeiger korrigieren.
			...
			lda	#CR			;<RETURN> in Tastaturpuffer.
			sta	KEYD
...
;*** Transferdaten.
;    Diese Variablen werden vor dem verlassen yum BASIC in der REU
...
:SaveDataRAM		w $8400				;Systemvariablen Teil #1 speichern.
			...
			w OS_VAR_MP-OS_LOW+$b900	;$9D80 = Start SysVar#2 in RAM.
			w R3_SIZE_MPVARBUF		;$B900 = Start SysVar#2 in REU.
			b $00

			w $8a00				;Aktuellen Mauszeiger retten.
			w $fc40
			w $0040
			b $00
