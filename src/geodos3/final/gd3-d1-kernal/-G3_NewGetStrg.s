...
:xGetString		lda	r0L			;Zeiger auf Eingabespeicher
			...
			sta	EndGetStrgAdr +0	;zwischenspeichern.
			lda	keyVector     +1
			sta	EndGetStrgAdr +1
...
:K_ENTER		cmp	#$0d			;<RETURN> gedrückt ?
			...
			jmp	(EndGetStrgAdr)		;Zurück zum Hauptprogramm.
...
:PrnClrCurText		sta	:2 +1
			...
			pha
			and	#%01000000		;Dialogbox aktiv ?
			beq	:1			;Nein, weiter...
			lda	#%1010000		;Bei Dialogbox immer in
