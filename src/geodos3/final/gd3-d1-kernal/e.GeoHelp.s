...
if .p
:zpageBuf		= LD_ADDR_HELPSYS - (APP_RAM - zpage)
endif

;*** Speicherbelegung.
;$0400-$04FF  GeoHelp-Loader.
;$1000-$3BFF  GeoHelp.
;$3C00-$5FFF  Textseite.
...
;--- GeoHelp starten.
			...
			jsr	LD_ADDR_HELPSYS+3	;HilfeSystem starten.
...
::ramtab
::x0600_0FFF		w LD_ADDR_GEOHELP +R2_SIZE_GEOHELP
			w LD_ADDR_GEOHELP +R2_SIZE_GEOHELP
			w (LD_ADDR_HELPSYS - LD_ADDR_GEOHELP) -R2_SIZE_GEOHELP

::x1000_3BFF		w LD_ADDR_HELPSYS
			w RH_ADDR_HELPSYS
			w RH_SIZE_HELPSYS

::x3C00_CFFF		w LD_ADDR_HELPSYS +RH_SIZE_HELPSYS
			w LD_ADDR_HELPSYS +RH_SIZE_HELPSYS
			w (vicbase - LD_ADDR_HELPSYS) -RH_SIZE_HELPSYS
...
;*** Endadresse testen.
;******************************************************************************
			g LD_ADDR_GEOHELP + R2_SIZE_GEOHELP -1
;******************************************************************************
