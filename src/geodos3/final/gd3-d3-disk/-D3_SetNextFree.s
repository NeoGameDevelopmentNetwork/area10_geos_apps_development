...
::52			sta	r6H			;Neue Sektoradresse speichern.
			jmp	xAllocateBlock
endif
...
::52			sec
			...
			beq	:57			; => Nein, nächster Track.
			bne	:55			; => Ja, freien Sektor suchen.
::53			lda	dir2Head +16,x		;Sektoren auf Track #01-#40 frei ?
::54			beq	:57			; => Nein, nächster Track.
...
:xSetNextFree		lda	#Tr_1stDataSek		;Startsektor im Bereich Native-
			...
			sta	r3H			; => Ja, Suche ab Tr/Se = $01/40.
...
::55			ldx	r6L			;Zeiger auf nächsten Track.
			inx				;Max. Diskgröße (16Mb) erreicht ?
			beq	:58			; => Ja, Ende...
			cpx	LastSearchTr		;Alle Tracks durchsucht ?
			beq	:56
			bcs	:58			; => Ja, Ende...
::56			stx	r6L			;Suche auf nächstem Track
			stx	r7L			;fortsetzen.

			ldy	#$00			;Suche ab Sektor #0 auf nächstem
			beq	:50			;Track fortsetzen.
...
::58			plp
			ldx	#INSUFF_SPACE		;Flag: "Diskette voll!".
			rts

::59			plp
			txa				;Disk-/Laufwerksfehler, Abbruch...
:exitSetNxFree		rts
endif
