...
::2			jsr	ClrInfoArea
			...
			LoadW	r6,FName1
			jsr	Get_GD_FILE		;Systemdatei von Diskette laden.
			txa				;Diskettenfehler ?
			bne	:1			; => Ja, Abbruch...

			LoadW	r0,FName1
			jsr	Del_GD_FILE		;Original-Datei löschen.
			txa				;Diskettenfehler ?
			bne	:1			; => Ja, Abbruch...
...
;da sonst evtl. Code verändert wird!
			jsr	DDX_Check		;GD3-Treiber mit DDX?
			bne	:3			; => Nein, weiter...

			PushB	DDRV_EXT_DATA1		;DDX-Variablen in MP3/GD3 sichern.
...
::4			LoadW	FInfoBlock,FName1
			jsr	Put_GD_FILE		;Systemdatei auf Diskette schreiben.
			txa				;Diskettenfehler ?
			bne	:1			; => Ja, Abbruch...
			...
			iny
;			ldx	curDrive		;":curDrive" bereits im xReg!
...
:Get_GD_FILE		lda	r6L			;Register ":r6" nach ":r0"
...
:Put_GD_FILE		jsr	PrintArea075p		;Fortschrittsanzeige.
...
;*** Systemtexte.
:FName1			b "GD.BOOT.1",NULL
:FName2			b "GD.BOOT",NULL
...
::53			b PLAINTEXT
			b "Sie können GeoDOS64 jetzt",NULL
::54			b "von dieser Diskette starten.",NULL
::60			b BOLDON
			b "HINWEIS: ",PLAINTEXT
...
::53			b PLAINTEXT
			b "You can now boot GeoDOS64 from",NULL
::54			b "this bootdisk.",NULL
::60			b BOLDON
			b "NOTE: ",PLAINTEXT
			b "A complete bootdisk also",NULL
::61			b "requires a desktop application",NULL
::62			b "file like `GEODESK` !",NULL
endif
