...
::maxTask		cmp	#8			;Alle Infotexte ausgegeben?
			...
			jmp	MAIN_RESETAREA		;Textgrenzen löschen.
...
::1			pha
			...
			sta	r0L			;Eingabetreiber oder Laufwerkstyp.
			lda	infoDataTab +7,y
			sta	r0H

			ldx	infoDataTab +5,y	;Info-Typ einlesen.
			beq	:3			; => Drucker/Eingabe, weiter...

;--- Laufwerksinfo anzeigen.
::2			PushW	r0 			;Zeiger auf Laufwerkstyp speichern.
			...
			PopW	r0			;Laufwerkstyp zurücksetzen.
