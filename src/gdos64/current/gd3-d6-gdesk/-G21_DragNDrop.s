...
::2			LoadB	r3L,1			;DnD-Icon abschalten.
			...
			jsr	MAIN_RESETAREA		;Grenzen für Mauszeiger löschen.
			...
			ldx	#NO_ERROR		;Fenster gefunden.
			ldy	WM_WCOUNT_OPEN		;Ziel-Fenster=DeskTop.
			dey
			lda	WM_STACK,y		;Fenster-Nr. einlesen.
			rts

::4			jsr	WM_FIND_WINDOW		;Wurde Icon auf Fenster abgelegt?
