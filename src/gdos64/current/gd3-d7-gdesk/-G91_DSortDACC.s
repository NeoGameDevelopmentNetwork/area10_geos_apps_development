...
::read			inc	a5L			;Anzahl Verzeichnis-Sektoren +1.
			...
			b $2c
::end			ldx	#NO_ERROR
::err_exit		jsr	DoneWithIO		;I/O-Bereich ausblenden.
			txa				;Fehler?
			bne	:error			; => Ja, Abbruch...
...
;			ldx	#$00			;Größe Verzeichnisblock = 256Bytes.
			...
			lda	sort64Kbank		;Adresse 64K-Bank im DACC.
			sta	r3L
...
::move			jsr	S_SetWinData		;Fenstergrenzen setzen.
...
::move			jsr	T_SetWinData		;Fenstergrenzen setzen.
...
::exitMouse		jsr	waitNoMseKey		;Warten bis keine M-Taste gedrückt.
