...
if LANG = LANG_DE
			h "CMD-RL/71-Laufwerk installieren."
			h "Nur für GDOS64!"
endif
if LANG = LANG_EN
			h "Install a CMD-RL/71 drive."
			h "For GDOS64 only!"
endif
...
:DriveAdr		= DrvAdrGEOS
:DrvMode		b DrvRL71			;Laufwerkstyp.
:DrvType		b Drv1571			;Laufwerksformat (Partitionstyp).
...
:initCopyDriver		lda	DrvMode			;Laufwerksmodus einlesen.
			...
			ldy	#SET_MODE_FASTDISK!SET_MODE_PARTITION
