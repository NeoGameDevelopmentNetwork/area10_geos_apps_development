...
if LANG = LANG_DE
			h "CMD-HD/NM-Laufwerk installieren."
			h "Nur für GDOS64!"
endif
if LANG = LANG_EN
			h "Install a CMD-HD/NM drive."
			h "For GDOS64 only!"
endif
...
:DriveAdr		= DrvAdrGEOS
:DrvMode		b DrvHDNM			;Laufwerkstyp.
...
;******************************************************************************
			e DDRV_SYS_DEVDATA
			d "obj.Drv_HDNM"
:HD_PP			d "obj.Drv_HDNM_PP"		;TurboPP-Treiber.
;******************************************************************************
