...
;******************************************************************************
;
; Standard-Maustreiber für C=1351, SmartMouse, SuperCPU & TC64.
; (c) 2023 M. Kanet
;
; 04.08.2023
; V5.1: Minor fixes.
...
<MISSING_IMAGE_DATA>
			...
			h "L:Single click, R:Single click"
...
;Bit%4: Linke Taste.
;Bit%0: Rechte Taste.
			and	#%00010001		;Maustasten gedrückt?
			beq	NoMKeyActive		; => Nein, weiter...

;--- Linke Maustaste abfragen.
:TestLKey		cmp	#%00010000		;Taste #1 gedrückt?
			bcc	TestRKey		; => Nein, weiter...

			ldx	#%10000000		;inputData +1: Linke Maustaste.
			bne	ExecMseClick

;--- Rechte Maustaste abfragen.
:TestRKey		lsr				;Rechte Maustaste gedrückt?
