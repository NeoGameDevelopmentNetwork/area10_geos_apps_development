...
;******************************************************************************
;*** Partition wechseln.
:xOpenPartition		jsr	xExitTurbo		;TurboDOS abschalten.
			...
			jmp	xOpenDisk		;Diskette öffnen.

;*** Partition wechseln.
;    Übergabe:		r3H	= Partitions-Nr.
:xSwapPartition		ldx	#ILLEGAL_PARTITION
			lda	r3H			;Partition definiert?
			beq	:ok			; => Nein, Kein Fehler, Ende...
			cmp	#PART_MAX +1		;Partition gültig?
			bcs	exitOpenPart		; => Nein, Abbruch...
...
;******************************************************************************
;*** Partition wechseln.
:xOpenPartition		jsr	initRAMLink		;RAMLink-Daten initialisieren.
			txa				;Fehler?
			bne	exitOpenPart		; => Ja, Abbruch...
