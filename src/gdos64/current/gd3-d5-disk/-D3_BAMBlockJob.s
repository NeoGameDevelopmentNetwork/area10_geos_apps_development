...
;******************************************************************************
::tmp0 = FD_NM!HD_NM!HD_NM_PP!IEC_NM!S2I_NM
if :tmp0 = TRUE
;******************************************************************************
...
:xGetBAMBlock		ldx	#NO_ERROR		;Flag für "Kein Fehler".
...
::51			tax				;Nr. des BAM-Sektors.
			ldy	#$ff			;Modus: Block lesen.
			bne	JobBAMBlock
...
;Rückgabe: -
;Geändert: AKKU,xReg,yReg
:xPutBAMBlock		ldx	#NO_ERROR		;Flag für "Kein Fehler".
			bit	BAM_Modified		;BAM im Speicher geändert ?
			bpl	EndBAMBlock		; => Nein, Ende...

			ldx	CurSek_BAM		;Nr. des BAM-Sektors.
			ldy	#$00			;Modus: Block speichern.
...
;--- Ergänzung: 19.01.23/M.Kanet
;GeoWrite nutzt intern das Register d0.
;Bei "ausschneiden" wird CalcBlksFree
;aufgerufen. Dabei wird GetBAMBlock
;verwendet wodurch d0 verändert werden
;kann und GeoWrite abstürzt.
			PushW	d0			;Register ":d0" sichern.
...
::53			PopW	d0			;Register ":d0" zurücksetzen.

			PopW	r4			;Register ":r1"/":r4" zurücksetzen.
			PopW	r1
...
;******************************************************************************
::tmp1 = RL_NM!RD_NM!RD_NM_SCPU!RD_NM_CREU!RD_NM_GRAM
if :tmp1 = TRUE
;******************************************************************************
;*** Sektor aus BAM einlesen und nach ":dir2Head" einlesen.
;Übergabe: AKKU = BAM-Sektor (#2 bis #33).
