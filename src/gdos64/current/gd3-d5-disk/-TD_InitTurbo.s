...
:InitTurboDOS		jsr	InitForIO		;I/O-Bereich einblenden.
...
::54			jmp	DoneWithIO		;I/O-Bereich ausblenden.
endif
...
:InitTurboDOS		jsr	InitForIO		;I/O-Bereich einblenden.
			...
			ldx	#> CMD_LdTurboDOS
			lda	#< CMD_LdTurboDOS
			jsr	SendCom5Byt		;TurboDOS aktivieren.
...
:InitTurboDOS		jsr	InitForIO		;I/O-Bereich einblenden.
			...
			lda	#20 -1			;(19+1) * 32 Bytes kopieren.
			sta	d1L
::51			jsr	CopyTurboDOSByt		;TurboDOS-Daten an Floppy senden.
			txa				;Laufwerkfehler ?
			bne	:54			; => Ja, Abbruch...
...
:InitTurboDOS		jsr	InitForIO		;I/O-Bereich einblenden.
			...
			lda	#12 -1			;(11+1) * 32 Bytes kopieren.
			sta	d1L
::51			jsr	CopyTurboDOSByt		;TurboDOS-Daten an Floppy senden.
			txa				;Laufwerkfehler ?
			bne	:54			; => Ja, Abbruch...
