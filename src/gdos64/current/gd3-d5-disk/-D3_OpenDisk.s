...
;--- Hinweis:
;":GetDiskSize" vor ":ChkRootGEOS"!
			jsr	xGetDiskSize		;Diskettengröße ermitteln.
			txa				;Diskettenfehler ?
			bne	:2			; => Ja, Abbruch...

;--- Hinweis:
;":ChkRootGEOS" vor ":GetDirHead"!
			jsr	ChkRootGEOS 		;Auf GEOS-Diskette testen.
...
;werden -> Absturz.
;Die RAMLink wird unter GDOS64 durch
;":NewDisk/:EnterTurbo" initialisiert.
...
::name			lda	curDirHead +$90,y
			...
			ldx	curDrive
			ldy	drivePartData-8,x	;Aktive Partition einlesen.
			lda	sysRAMLink		;Geräteadresse RL in AKKU.
...
;Diese führt dann ":FindRAMLink" aus.
			jsr	xNewDisk		;Diskette/Partition testen.
			txa				;Diskettenfehler ?
			bne	:dskerr			; => Ja, Abbruch...
...
;--- Hinweis:
;":GetDiskSize" vor ":ChkRootGEOS"!
;			jsr	xEnterTurbo		;Wird durch ":NewDisk" ausgeführt.
			jsr	xGetDiskSize		;Diskettengröße ermitteln.
			txa				;Diskettenfehler ?
			bne	:dskerr			; => Ja, Abbruch...
