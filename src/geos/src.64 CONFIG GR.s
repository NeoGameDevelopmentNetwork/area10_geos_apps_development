...
:CheckSizeRAM		lda	r1L			;Register ":r1L" zwischenspeichern.
			...
			lda	#$08			;Max. Anzahl Speicherbänke in REU.
			sta	SizeOfREU
...
:l0da8			dey				;Warteschleife.
			...
			bne	l0e0b			;Nein, keine REVU...

			lda	r1L			;Register $DE00 zurücksetzen.
			sta	$de00

			lda	#$08			;Mind. 8 Speicherbänke in der
			sta	ramExpSize		;REU verfügbar.
...
:LE14F			lda	r0L			;Zeiger auf C64-Adresse korrigieren.
:LE151			clc
:LE152			adc	r7L
:LE154			sta	r0L
:LE156			lda	r0H
...
:SvScrnAreas		b $08,$20,$19,$68		;Daten für Dialogbox.
			b $00,$0e,$0f,$1e		;Daten für PullDown-Menü.
