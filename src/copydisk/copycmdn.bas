...
;
   ...
   69 :
   70 ex$=".dnp":na$="cmdn"
   71 tc=0 :rem track count  / 0=auto-detect
   72 sc=0 :rem sector count / 0=256 blocks
   79 :
   80 t0$="                                       "
   99 :
  ...
  490 return
  499 :
  500 rem get max. track from disk
  510 open15,d0,15:open2,d0,2,"#"
  511 print#15,"u1";2;0;1;2
  512 print#15,"b-p";2;8:get#2,a$:tc=asc(a$+chr$(0))
  520 close2:close15
  530 if(tc=0)thenprint"bad disk or diskimage!":end
  540 return
  549 :
  550 rem get max. track from disk image
  551 print"{down}analyzing disk image..."
  560 open2,d0,0,f$+ex$+",p,r":sysdn:close2
  570 tc=peek(mt):if(tc=0)thenprint"bad disk or diskimage!":end
  580 print"{up}";t0$;"{up}{up}"
  590 return
  599 :
 ...
 1049 :
 1050 if(tc=0)thengosub500 :rem get max. track
 1099 :
 ...
 2049 :
 2050 if(tc=0)thengosub500 :rem get max. track
 2099 :
 ...
 3049 :
 3050 if(tc=0)thengosub550 :rem get max. track
 3099 :
