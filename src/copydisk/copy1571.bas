...
;
  ...
  115 open15,d0,15,"u0>m1":close15 :rem set 1571-mode
  ...
  125 open15,d1,15,"u0>m1":close15 :rem set 1571-mode
  129 :
  ...
  490 return
  499 :
  500 rem set max sector / track
  501 sc=0
  510 if(tr>= 0)and(tr<=17)thensc=21
  520 if(tr>=18)and(tr<=24)thensc=19
  530 if(tr>=25)and(tr<=30)thensc=18
  540 if(tr>=31)and(tr<=35)thensc=17
  550 if(tr>=36)and(tr<=52)thensc=21
  560 if(tr>=53)and(tr<=59)thensc=19
  570 if(tr>=60)and(tr<=65)thensc=18
  580 if(tr>=66)and(tr<=70)thensc=17
  590 if(sc=0)thenecho"error! track not valid!":end
  595 return
  599 :
 ...
 1220 : gosub500  :rem get sector count
 ...
 2220 : gosub500  :rem get sector count
 ...
 3220 : gosub500  :rem get sector count
