...
;*** Hilfeseite anzeigen.
:xPRINT_INFO		jsr	ResetFontGD		;Zeichensatz zurücksetzen.
			...
			jmp	WM_LOAD_BACKSCR		;Bildschirm zurücksetzen.
...
:waitMseKey		jsr	WM_WAIT_NOMSEKEY	;Warten bis keine M-Taste gedrückt.
...
IPosXY l2pos3,l2y09
			b "F1"
			IPosX l2pos4
			b "Datei-Icons anzeigen"
IPosXY l2pos3,l2y10
			b "F3"
			IPosX l2pos4
			b "Kompakt-/Detail-Modus"
IPosXY l2pos3,l2y11
			b "F5"
			IPosX l2pos4
...
IPosXY l2pos3,l2y09
			b "F1"
			IPosX l2pos4
			b "Display file icons"
IPosXY l2pos3,l2y10
			b "F3"
			IPosX l2pos4
			b "Compact- or detail-mode"
IPosXY l2pos3,l2y11
			b "F5"
			IPosX l2pos4
			b "Sort by file name"
