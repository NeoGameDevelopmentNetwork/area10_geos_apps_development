...
if .p
;--- Hinweis:
;Erweiterte Laufwerksfehler.
;Nicht in TopSym definiert um
;Symbolspeicherplatz zu sparen.
; :NO_ERROR		= $00				;In TopSym.MP3 definiert.
:NO_BLOCKS		= $01
; :INV_TRACK		= $02				;In TopSym.MP3 definiert.
:INSUFF_SPACE		= $03
; :FULL_DIRECTORY	= $04				;In TopSym.MP3 definiert.
; :FILE_NOT_FOUND	= $05				;In TopSym.MP3 definiert.
; :BAD_BAM		= $06				;In TopSym.MP3 definiert.
:UNOPENED_VLIR		= $07
:INV_RECORD		= $08
:OUT_OF_RECORDS		= $09
; :STRUCT_MISMAT	= $0a				;In TopSym definiert.
:BFR_OVERFLOW		= $0b
; :CANCEL_ERR		= $0c				;In TopSym.MP3 definiert.
; :DEV_NOT_FOUND	= $0d				;In TopSym.MP3 definiert.
; :INCOMPATIBLE		= $0e				;In TopSym definiert.
:HDR_NOT_THERE		= $20
; :NO_SYNC		= $21				;In TopSym.MP3 definiert.
:DBLK_NOT_THERE		= $22
:DAT_CHKSUM_ERR		= $23
:WR_VER_ERR		= $25
; :WR_PR_ON		= $26				;In TopSym.MP3 definiert.
:HDR_CHKSUM_ERR		= $27
:DSK_ID_MISMAT		= $29
:BYTE_DEC_ERR		= $2e
:NO_PARTITION		= $30
...
:NO_PART_FD_ERR		= $33
:ILLEGAL_DEVICE		= $40
; :NO_FREE_RAM		= $60				;In TopSym.MP3 definiert.
:DOS_MISMATCH		= $73
...
:xSTATMSG		lda	curDrive		;Aktuelles Laufwerk einlesen und
			...
			MoveW	r0,:txDrvType		;Text in Fehlermeldung übernehmen.
...
::setError		lda	#<Dlg_Titel_Error	;Titelzeile "Fehler".
			ldx	#>Dlg_Titel_Error
;			bne	:setHeader
...
:m29b			b "Write protected or bad disk ID!",NULL
...
;--- 60: NO_FREE_RAM
:m60a			b PLAINTEXT
			b "Drive can not be installed:",NULL
