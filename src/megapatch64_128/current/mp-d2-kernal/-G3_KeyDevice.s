...
:GetMatrixCode		;PushB	CLKRATE
			...
			jsr	NewKeyInBuf
			lda	Flag_CrsrRepeat
			sta	keyMode			;Repeatgeschwindigkeit setzen
::1			LoadB	r1H,0
			jsr	CheckKeyboard
			bne	:3
			jsr	SHIFT_CBM_CTRL
...
::2			jsr	CheckKeyboard
			...
			cpy	#8
			bcc	:4
			lda	KeyMatrixData-8,y
			sta	$d02f			;VIC Keyboard-Kontrollregister
			bne	:5
::4			lda	KeyMatrixData,y
			sta	$dc00
::5			lda	$dc01
			cmp	KB_LastKeyTab,y
			sta	KB_LastKeyTab,y
			bne	:6
			cmp	KB_MultipleKey,y
			beq	:6
			pha
			eor	KB_MultipleKey,y
			beq	:7
			jsr	MultipleKeyMod
::7			pla
			sta	KB_MultipleKey,y
::6			dey
			bpl	:2
::3			;PopB	CLKRATE
			rts
...
:keyTab0		b $1d,$0d,$1e,$0e,$01,$03,$05,$11
			...
			b $1f,$2b,$7b,$12,$1f,$23,$1f,$2d
			b $31,$14,$1f,$32,$20,$1f,$71,$16
			b $19,$38,$35,$09,$32,$34,$37,$31
			b $1b,$2b,$2d,$0a
			;b $0b				;ENTER-Taste alt
			b $0d				;ENTER-Taste neu = RETURN
			b $36,$39,$33
			b $1a,$30,$2e,$10,$11,$08,$1e,$07
...
:keyTab1		b $1c,$0d,$08,$0f,$02,$04,$06,$10
			...
			b $19,$38,$35,$09,$32,$34,$37,$31
			b $1b,$2b,$2d,$0a
			;b $0b				;Shift + ENTER-Taste alt
			b $0d				;Shift + ENTER-Taste neu = RETURN
			b $36,$39,$33
			b $1a,$30,$2e,$10,$11,$08,$1e,$07
