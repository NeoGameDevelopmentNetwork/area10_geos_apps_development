...
::4			LoadW	FInfoBlock,FName1
			...
			iny
			lda	RealDrvMode -8,x	;Laufwerkstyp in Systemdatei
			sta	(r1L),y			;übertragen.
...
;*** Text ausgeben.
:PrintArea000p		LoadW	r4,(118 +2* 000 -1) ! DOUBLE_W
			lda	#0
			beq	PrintStatus
:PrintArea025p		LoadW	r4,(118 +2* 025 -1) ! DOUBLE_W
			lda	#25
			bne	PrintStatus
:PrintArea050p		LoadW	r4,(118 +2* 050 -1) ! DOUBLE_W
			lda	#50
			bne	PrintStatus
:PrintArea075p		LoadW	r4,(118 +2* 075 -1) ! DOUBLE_W
			lda	#75
			bne	PrintStatus
:PrintArea100p		LoadW	r4,(118 +2* 100 -1) ! DOUBLE_W
			lda	#100
:PrintStatus		pha
			LoadB	r2L,$ba
			LoadB	r2H,$c5
...
;*** Systemtexte.
:FName1			b "GEOS128.1",NULL
:FName2			b "GEOS128.BOOT",NULL
...
::1			b "Funktion abgebrochen:",NULL
endif
if Sprache = Englisch
::51			b PLAINTEXT,BOLDON
			b "Systemerror",NULL
::1			b "Function cancelled:",NULL
endif
...
::1			b "Die Startdiskette wird",NULL
::2			b "konfiguriert. Bitte warten...",NULL
endif
if Sprache = Englisch
::51			b PLAINTEXT,BOLDON
			b "GEOS.MakeBoot",NULL
::1			b "Bootdisk will be configured,",NULL
::2			b "please wait...",NULL
endif
