...
;funktioniert nicht).
;Das Problem betrifft nur GEOS64.
;:VARTAB		= $002d
;:EAL			= $00ae
;:TAPE1			= $00b2
;:NDX			= $00c6
...
:CLKRATE		=	$d030			;Geschwindigkeitsregister (1/2Mhz)
...
;SETBANKFILE = SETBNK
;Die Routine ist im GEOS128-Kernal nicht verfügbar, siehe src.GEOS_MP3.128 ab $FF81.
;SETBNK muss nachgebildet werden über: STA $C6 / STX $C7.
:SETBANKFILE		=	$ff68			;Nur in BASIC während GEOS.BOOT/RBOOT verwenden!
