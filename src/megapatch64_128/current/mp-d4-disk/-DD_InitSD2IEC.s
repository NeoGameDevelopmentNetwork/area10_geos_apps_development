...
:TestSD2IEC		tya				;1541: Y-Reg sichern.
			...
			lda	DriveAdr		;Laufwerksadresse einlesen und
			jsr	DetectDrive		;testen ob Laufwerk aktiv.
			bne	:1			; => Nein, Abbruch...
...
;*** Ist Laufwerk am IEC-Bus vorhanden?
;    Übergabe: AKKU = Laufwerksadresse.
;    Rückgabe: AKKU = $00: OK.
:DetectDrive		pha				;Laufwerksadresse sichern.
...
:skipDrvStatus		jsr	initDevTALK		;Laufwerk auf Senden schalten.
			bne	:err			;Fehler? => Ja, Abbruch...

::1			jsr	ACPTR			;Fehlerstatus überspringen.
			lda	STATUS
			beq	:1
