...
::tmp1 = :tmp1a!:tmp1b
if Flag64_128!:tmp1!TDOS_MODE = TRUE_C64!TRUE!TDOS_DISABLED
;******************************************************************************
;*** Datenkanal öffnen.
...
;******************************************************************************
::tmp2a = C_41!C_71!C_81!IEC_NM!S2I_NM
::tmp2b = FD_41!FD_71!FD_81!FD_NM!HD_41!HD_71!HD_81!HD_NM
::tmp2 = :tmp2a!:tmp2b
if Flag64_128!:tmp2!TDOS_MODE = TRUE_C128!TRUE!TDOS_DISABLED
;******************************************************************************
;*** Datenkanal öffnen.
:openDataChan		lda	#$00			;Status löschen.
			sta	STATUS
...
;--- Hinweis:
;SETBNK ist im GEOS-Kernal nicht vorhanden, da beim C128 die
