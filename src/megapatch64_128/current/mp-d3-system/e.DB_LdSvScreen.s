...
:ResetDlgGrafx		clc				;Größe der Box berechnen.
			jsr	DB_TestUpsize		;ohne Schatten
if Flag64_128 = TRUE_C128
			ldx	#r3L			;X-Koordinaten anpassen
			jsr	NormalizeX
			ldx	#r4L
			jsr	NormalizeX
			lda	graphMode		;welcher Grafikmodus?
			bpl	:40			;>40 Zeichen VIC
			lda	DataJobCode		;>80 Zeichen VDC
			cmp	#$90			;>Load/Save Bildschirm?
			bne	:load			;>Load
			ldy	#0			;Kennzeichen für kein Spooler
			tya				;Bildschirm nicht löschen
			sec				;Bildschirm komplett innerhalb VDC kopieren
			jmp	xSave80Screen		;Routine im Kernal Bank 0
::load			ldy	#0			;Kennzeichen für kein Spooler
			sec				;Bildschirm komplette aus VDC wiederherstellen
			jmp	xLoad80Screen		;Routine im Kernal Bank 0
::40
endif
...
;*** Endadresse testen.
;******************************************************************************
			g LD_ADDR_DB_SCREEN + R2_SIZE_DB_SCREEN -1
;******************************************************************************
