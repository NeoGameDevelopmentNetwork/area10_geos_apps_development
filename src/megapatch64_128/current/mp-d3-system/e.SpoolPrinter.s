...
;--- Ergänzung: 08.07.18/M.Kanet
;Code-Rekonstruktion: In der Version von 2003 wurde eine zusätzliche
;Einsprungadresse ergänzt. Genaue Funktion noch unklar.
:xPrintDATA		jmp	SpoolDATA
...
::4			ldy	#63			;C128 hat ein Byte mehr!
			...
			ldy	#62			;Grafikspeicher für Sprites
endif
...
if Flag64_128 = TRUE_C128
			...
			b	168,168+23
			w	584,584+47
			lda	#$0d			;Farbe schwarz/gelb setzen
			jsr	DirectColor

::4			ldy	#63			;C128 hat ein Byte mehr!
else
			ldy	#62			;Spritegrafik retten und
endif
...
if Flag64_128 = TRUE_C128
			...
			lda	#$00			;Hintergrundsprite im VDC nicht darstellen
::4a
endif
			sta	spr7pic   ,y
			dey
...
if Flag64_128 = TRUE_C128
			ldy	#63
			lda	#$01			;Sprite-Höhe = 1 für VDC-Sprite
			sta	spr7pic   ,y
endif
...
if Flag64_128 = TRUE_C128
			...
			ora	#%01000000		;80 Zeichen Sprite in X-Richtung verdoppeln
::40
endif
			sta	mobx2
			lda	moby2
...
if Flag64_128 = TRUE_C128
			...
			LoadW	r4 ,584			;X-Koordinate 80 Zeichen
			jmp	:80
::40			LoadW	r4 ,288			;X-Koordinate 40 Zeichen
::80			LoadB	r3L,6			;Sprites aktivieren.
			LoadB	r5L,170			;Y-Koordinate
			jsr	PosSprite
			jsr	EnablSprite
			bit	graphMode
			bpl	:4			;bei 80Zeichen kein Hintergrundsprite setzen
...
::8
			...
			lda	#$00			;Formel:      GRÖßE  * 21
			sta	r1L			;        ---------------------
			sta	r0H			;           Max_Size_Buffer
			lda	Flag_SpoolMaxB
			sec				;da aber Größe * Max_B_Balken größer als
			sbc	Flag_SpoolMinB		;$ffff werden kann (bei der Multiplikation)
			clc				;wird folgende Berechnung durchgeführt>
			adc	#$01			;Bruchrechnen... genial...
			sta	r1H			;       GRÖßE  * 21          / 21
			LoadB	r0L,21			;  -----------------------    -----
			ldx	#r1L			;     Max_Size_Buffer       / 21
			ldy	#r0L			;ergibt>
			jsr	Ddiv			;         GRÖßE
				 			;   -----------------
			lda	Flag_SpoolADDR +1	; Max_Size_Buffer / 21
			sta	r0L			;wunderbar...
