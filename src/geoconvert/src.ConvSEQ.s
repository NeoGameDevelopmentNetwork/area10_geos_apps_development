...
:START_SEQ		lda	FileConvMode
			cmp	#ConvMode_MERGE_FILE
			beq	SEQ_Verbinden
			jmp	SEQ_Trennen

;*** Auswahl SEQ-Format.
:SEQ_Verbinden		ldx	Option_SEQ_Merge
			bne	AppendToSEQ
...
:PrnSrcFile		LoadW	r0,Text_SourceInfo
			jsr	PutString
...
:PrnTgtFile		LoadW	r0,Text_TargetInfo
			jsr	PutString
...
if Sprache = Deutsch
:Text_SourceInfo	b PLAINTEXT,BOLDON
			b GOTOXY
			w $0048
			b $58
			b "Quelle"
