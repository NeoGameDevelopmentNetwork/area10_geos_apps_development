...
::101			LoadW	r6,FileNameDOS		;Zeiger auf Dateiname setzen.
			jsr	FindFile		;Datei suchen.
			txa				;Quell-Datei gefunden?
			beq	:102			; => Ja, weiter...
			rts				;Diskettenfehler, Abbruch.
...
::106			lda	#"0"			;Bei doppelten Dateinamen
			sta	FileNameDOS,y		;Index-Zähler setzen.
			iny
			sta	FileNameDOS,y
			dey
			sty	r15L
...
::107			ldx	r15L
			...
			lda	#"0"
			sta	FileNameDOS+1,x
			inc	FileNameDOS+0,x		;Dateiname kopieren.
			jmp	:101			;Weiter mit nächstem Zeichen.
...
.SetNameDOS		PushW	r0
			...
			ldy	#12			;Rest des Dateinamens löschen.
			lda	#$00
...
;*** Zeichen in ASCII-Format wandeln.
