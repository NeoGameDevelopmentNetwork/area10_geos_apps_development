...
German version : 'mp33r8-de.d81'
English version: 'mp33r8-en.d81'
...
## UPDATE 21/01/24
The stable release V3.3r8 contains at least on bug that will cause DeskTop V2 to crash if you have two drives configured. With one drive or more then two drives this is not a problem.
This issue has been fixed in the latest snapshot.
